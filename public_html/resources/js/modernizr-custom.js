...
!function (e, A, n) {
    ...
    function s() {
        ...
        for (var f in l) if (l.hasOwnProperty(f)) {
            ...
            for (s = o(A.fn, "function") ? A.fn() : A.fn, a = 0; a < e.length; a++) t = e[a], r = t.split("."), 1 === r.length ? Modernizr[r[0]] = s : (!Modernizr[r[0]] || Modernizr[r[0]] instanceof Boolean || (Modernizr[r[0]] = Boolean(Modernizr[r[0]])), Modernizr[r[0]][r[1]] = s), i.push((s ? "" : "no-") + r.join("-"))
        }
    }
    ...
    function t(e, A) {
        if ("object" == typeof e) for (var n in e) f(e, n) && t(n, e[n]); else {
            ...
            A = "function" == typeof A ? A() : A, 1 == o.length ? Modernizr[o[0]] = A : (!Modernizr[o[0]] || Modernizr[o[0]] instanceof Boolean || (Modernizr[o[0]] = Boolean(Modernizr[o[0]])), Modernizr[o[0]][o[1]] = A), a([(A && 0 != A ? "" : "no-") + o.join("-")]), Modernizr._trigger(e, A)
        }
        return Modernizr
    }
